@extends('layouts.app')
@section('title')Обновить действие @endsection

@section('heading')NetPing - редактировать действие@endsection

@section('content')
<div class="mt-5 md:m-0 md:m-auto md:w-2/4 justify-center">
    <form method="post" action="{{ route('update_action', $action->id) }}">
        @csrf
