<!-- navbar goes here -->
<nav class="border-b border-gray-100 dark:bg-gray-900 dark:border-gray-500 h-100">
        ...
        <div class="flex justify-between">
            ...
            <div class="flex space-x-4">
                ...
                <div>
                    <a href="{{ route('home') }}"
                        ...
                        <span class="font-bold px-2">NetPing</span>
                    </a>
                </div>
                ...
                <div class="hidden md:flex items-center space-x-1">
                    ...
                    <a href="{{ route('bdcom.graphs')}}"
                       class="flex justify-between items-center space-x-1 py-5 px-2 text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white dark:focus:text-white @if(Route::currentRouteName() == 'bdcom.graphs')active_menu @endif">
            ...
            <div class="md:hidden flex items-center">
                <button class="mobile-menu-button">
                    <svg class="w-6 h-6 stroke-current dark:stroke-gray-400" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="mobile-menu hidden md:hidden divide-y divide-gray-400">
        <div class="py-1">
            ...
            @if(Auth::user()->isAdmin())
            <a href="{{ route('users') }}" class="flex flex-row items-center space-x-1 block py-2 px-4 text-sm hover:bg-gray-200 dark:text-gray-400 dark:hover:text-white dark:focus:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
